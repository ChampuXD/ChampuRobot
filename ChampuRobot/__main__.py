...
PM_START_TEXT = """ 
*ʜᴇʏ* {} , 🥀  
*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ʏᴏᴜʀ ᴜʟᴛɪᴍᴀᴛᴇ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ᴀssɪsᴛᴀɴᴛ!*  
*ʜɪᴛ ʜᴇʟᴘ ᴛᴏ ᴇxᴘʟᴏʀᴇ ᴍʏ ғᴜʟʟ ᴘᴏᴛᴇɴᴛɪᴀʟ!*  
➻ *ᴛʜᴇ ᴍᴏsᴛ ᴘᴏᴡᴇʀғᴜʟ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜsɪᴄ ʙᴏᴛ ᴡɪᴛʜ ᴀᴡᴇsᴏᴍᴇ ᴀɴᴅ ᴜsᴇғᴜʟ ғᴇᴀᴛᴜʀᴇs.*  

ʟᴇᴛ's ᴍᴀᴋᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ᴇxᴘᴇʀɪᴇɴᴄᴇ ᴇxᴛʀᴀᴏʀᴅɪɴᴀʀʏ! 🚀
"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ᴏɴᴡᴇʀ", url=f"tg://user?id={OWNER_ID}"),
    ],  
    [
        InlineKeyboardButton(text="sᴜᴩᴩᴏʀᴛ", callback_data="Champu_support"),
        InlineKeyboardButton(text="ᴄʜᴀᴍᴘᴜ", url=f"https://t.me/TheChampu"),
    ],   
...
ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ @itsMeShivanshu ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʏ ᴅᴏɴᴀᴛᴇ ᴏɴ ᴜᴘɪ Champu@Upi."""
        ...
        if mod_match:
            ...
            query.message.edit_caption(text,
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="Champu_support")]]
                ),
            )
        ...
        query.message.edit_caption(f"*ʜᴇʏ,*🥀\n  *ᴛʜɪs ɪs {dispatcher.bot.first_name}*"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", callback_data="Champu_support"
                        ),
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(text="ʜᴏᴍᴇ", callback_data="Champu_back"),
                    ],
                ]
            ),
        )
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/TheChampu"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="ᴄʜᴧᴍᴘᴜ", url=f"https://t.me/itsMeShivanshu"
                        ),
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ", url="https://github.com/ChampuXD"
                        ),
                    ],
                    [
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton(text="Hᴏᴍᴇ", callback_data="Champu_back")]
                ]
            ),
        )
...
Aᴠᴀɪʟᴀʙʟᴇ ᴛᴏ Aᴅᴍɪɴs.
 ...
 /staff ɢɪᴠᴇs ᴛʜᴇ ᴄᴏᴍᴘʟᴇᴛᴇ Lɪsᴛ ᴏғ ɢʀᴏᴜᴘ Sᴛᴀғғ!.""",parse_mode=ParseMode.MARKDOWN,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="• ʙᴀᴄᴋ •", callback_data="Main_help"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="Champu_support")
                    ]
                ]
            ),
            )
...
[{BOT_NAME}]("https://t.me/{BOT_USERNAME}") ɪs ɴᴏᴡ ᴀᴛ ʏᴏᴜʀ sᴇʀᴠɪᴄᴇ ᴛᴏ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴇғғᴇᴄᴛɪᴠᴇʟʏ.

**ᴀᴅᴍɪɴ ᴛᴏᴏʟs**:
ᴇᴍᴘᴏᴡᴇʀ ʏᴏᴜʀsᴇʟғ ᴡɪᴛʜ ʙᴀsɪᴄ ᴀᴅᴍɪɴ ᴛᴏᴏʟs ᴛᴏ sᴀғᴇɢᴜᴀʀᴅ ᴀɴᴅ sᴜᴘᴇʀᴄʜᴀʀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ. ʙᴀɴ, ᴋɪᴄᴋ, ᴏʀ ᴘʀᴏᴍᴏᴛᴇ ᴍᴇᴍʙᴇʀs sᴇᴀᴍʟᴇssʟʏ ᴜsɪɴɢ ᴛʜᴇ ʙᴏᴛ.

**ɢʀᴇᴇᴛɪɴɢs**:
ʟᴇᴛ's ᴄʀᴀғᴛ ᴀ ᴡᴀʀᴍ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇ ғᴏʀ ɴᴇᴡ ᴜsᴇʀs ᴊᴏɪɴɪɴɢ ʏᴏᴜʀ ɢʀᴏᴜᴘ. ᴜsᴇ /sᴇᴛᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴄᴜsᴛᴏᴍɪᴢᴇ ʏᴏᴜʀ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇ!

ʟᴇᴠᴇʟ ᴜᴘ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ᴡɪᴛʜ [ᴄʜᴧᴍᴘᴜ]("https://t.me/TheChampu")!""",parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_caption("""ᴇᴍᴘᴏᴡᴇʀ ᴄʜᴀᴍᴘᴜxʀᴏʙᴏᴛ's ɢʀᴏᴡᴛʜ ᴀɴᴅ ᴇɴsᴜʀᴇ ɪᴛs ᴠɪᴛᴀʟɪᴛʏ! ʏᴏᴜʀ ᴄᴏɴᴛʀɪʙᴜᴛɪᴏɴs ғᴜᴇʟ sᴇʀᴠᴇʀ ᴍᴀɪɴᴛᴇɴᴀɴᴄᴇ ᴀɴᴅ ᴇxᴄɪᴛɪɴɢ ᴜᴘɢʀᴀᴅᴇs. ᴇᴠᴇʀʏ ᴅᴏɴᴀᴛɪᴏɴ ɪɴsᴘɪʀᴇs ᴜs ᴛᴏ ɪɴɴᴏᴠᴀᴛᴇ ᴀɴᴅ ɪɴᴛʀᴏᴅᴜᴄᴇ ғʀᴇsʜ ғᴇᴀᴛᴜʀᴇs. ᴀᴄᴛ ɴᴏᴡ ᴛᴏ sᴇᴄᴜʀᴇ ᴄʜᴀᴍᴘᴜxʀᴏʙᴏᴛ's ғᴜᴛᴜʀᴇ ᴀɴᴅ ʙᴇ ᴀ ᴘᴀʀᴛ ᴏғ ɪᴛs ᴇᴠᴏʟᴜᴛɪᴏɴ. ᴛᴏɢᴇᴛʜᴇʀ, ʟᴇᴛ's sʜᴀᴘᴇ ᴀ ʙʀɪɢʜᴛᴇʀ ᴛᴏᴍᴏʀʀᴏᴡ!""",parse_mode=ParseMode.MARKDOWN,
            
            reply_markup=InlineKeyboardMarkup(
                [ 
                    [
                        InlineKeyboardButton(text="Dᴏɴᴀᴛᴇ", url="https://t.me/Champu_Editz/105"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="Champu_support")
                    ],
                    [
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Aᴅᴍɪɴ", callback_data="Music_admin"
                        ),
                        InlineKeyboardButton(
                            text="Aᴜᴛʜ", callback_data="Music_auth"
                        ),
                        InlineKeyboardButton(
                            text="Bʀᴏᴀᴅᴄᴀsᴛ", callback_data="Music_broadcast"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="Bʟ-Cʜᴀᴛ", callback_data="Music_blchat"
                        ),
                        InlineKeyboardButton(
                            text="Bʟ-Usᴇʀ", callback_data="Music_bluser"
                        ),
                        InlineKeyboardButton(
                            text="C-Pʟᴀʏ", callback_data="Music_cplay"
                        ),
                    ],            
                    [
                        InlineKeyboardButton(
                            text="G-Bᴀɴ", callback_data="Music_gban"
                        ),
                        InlineKeyboardButton(
                            text="Lᴏᴏᴘ", callback_data="Music_loop"
                        ),
                        InlineKeyboardButton(
                            text="Mᴀɪɴᴛᴇɴᴀɴᴄᴇ", callback_data="Music_maintenance"
                        ),
                    ],               
                    [
                        InlineKeyboardButton(
                            text="Pɪɴɢ", callback_data="Music_ping"
                        ),
                        InlineKeyboardButton(
                            text="Pʟᴀʏ", callback_data="Music_play"
                        ),
                        InlineKeyboardButton(
                            text="Sʜᴜғғʟᴇ", callback_data="Music_shuffle"
                        ),
                    ],       
                    [
                        InlineKeyboardButton(
                            text="Sᴇᴇᴋ", callback_data="Music_seek"
                        ),
                        InlineKeyboardButton(
                            text="Sᴏɴɢ", callback_data="Music_song"
                        ),
                        InlineKeyboardButton(
                            text="Sᴘᴇᴇᴅ", callback_data="Music_speed"
                        ),
                    ],                                               
                    [
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=" ʙᴀᴄᴋ ", callback_data="Music_"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="Champu_support")
                    ]
                ]
            ),
        )
    elif query.data == "Music_auth":
        query.message.edit_caption(f"*» ᴀᴜᴛʜ ᴄᴏᴍᴍᴀɴᴅꜱ «*"
            f"""
...
""",
        ...
        query.message.edit_caption(f"*» ʙʀᴏᴀᴅᴄᴀsᴛ ᴄᴏᴍᴍᴀɴᴅꜱ «*"
            f"""
...
""",
        ...
        query.message.edit_caption(f"*» ᴄʜᴀᴛ ʙʟᴀᴄᴋʟɪsᴛ ғᴇᴀᴛᴜʀᴇ «*"
            f"""
...
""",
        ...
        query.message.edit_caption(f"*» ʙʟᴏᴄᴋ ᴜsᴇʀs «*"
            f"""
[ᴏɴʟʏ ғᴏʀ sᴜᴅᴏᴇʀs]
...
""",
        ...
        query.message.edit_caption(f"*» ᴄʜᴀɴɴᴇʟ ᴩʟᴀʏ ᴄᴏᴍᴍᴀɴᴅs «*"
            f"""
...
""",
        ...
        query.message.edit_caption(f"*» ɢʟᴏʙᴀʟ ʙᴀɴ ғᴇᴀᴛᴜʀᴇ «*"
            f"""
...
""",
        ...
        query.message.edit_caption(f"*» ʟᴏᴏᴘ sᴛʀᴇᴀᴍ «*"
            f"""
...
""",
        ...
        query.message.edit_caption(f"*» ᴍᴀɪɴᴛᴇɴᴀɴᴄᴇ ᴍᴏᴅᴇ «*"
            f"""
...
""",
        ...
        query.message.edit_caption(f"*» ᴘɪɴɢ & sᴛᴀᴛs «*"
            f"""
...
""",
        ...
        query.message.edit_caption(f"*» sʜᴜғғʟᴇ ᴏ̨ᴜᴇᴜᴇ «*"
            f"""
...
""",
        ...
        query.message.edit_caption(f"*» sᴇᴇᴋ sᴛʀᴇᴀᴍ «*"
            f"""
...
""",
        ...
        query.message.edit_caption(f"*» sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅ «*"
            f"""
...
""",
        ...
        query.message.edit_caption(f"*» sᴘᴇᴇᴅ ᴄᴏᴍᴍᴀɴᴅs «*"
            f"""
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        if len(args) >= 2 and any(args[1].lower() == x for x in HELPABLE):
            ...
            return
        update.effective_message.reply_video(START_IMG,"» Wʜᴇʀᴇ ᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴏᴘᴇɴ ᴛʜᴇ sᴇᴛᴛɪɴɢs ᴍᴇɴᴜ?.",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
        ...
        send_help(
            ...
            text,
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="◁", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="Champu_support")]]
            ),
        )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 6399386263:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [ɢɪᴛʜᴜʙ](https://github.com/ChampuXD/ChampuRobot)"
