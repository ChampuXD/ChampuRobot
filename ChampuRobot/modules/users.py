...
import ChampuRobot.modules.no_sql.users_db as user_db 
from ChampuRobot import app as Champu
from ChampuRobot import DEV_USERS, LOGGER as  logger, OWNER_ID, dispatcher
from ChampuRobot.modules.helper_funcs.chat_status import dev_plus, sudo_plus
from ChampuRobot.modules.no_sql.users_db import get_all_users
...
@dev_plus
@Champu.on_message(filters.command(["bchat","broadcastgroups"]) & filters.user(OWNER_ID) & filters.reply)
...
@dev_plus
# broadcast
@Champu.on_message(filters.command(["buser","broadcastusers"]) & filters.user(OWNER_ID) & filters.reply)
async def broadcast_handler(bot: Client, m: Message):
...
__help__ = f"""*Bʀᴏᴀᴅᴄᴀsᴛ: (Bot owner only)*
*Note:* This supports basic markdown
 ❍ /broadcastall*:* Bʀᴏᴀᴅᴄᴀsᴛ ᴇᴠᴇʀʏᴡʜᴇʀᴇ
 ❍ /broadcastusers*:* Bʀᴏᴀᴅᴄᴀsᴛ ᴛᴏᴏ ᴀʟʟ ᴜsᴇʀs
 ❍ /broadcastgroups*:* Bʀᴏᴀᴅᴄᴀsᴛ ᴛᴏᴏ ᴀʟʟ ɢʀᴏᴜᴘs"""  
