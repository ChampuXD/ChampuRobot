...
def totranslate(update: Update, context: CallbackContext) -> None:
    ...
    if not reply_msg:
        message.reply_text(
            ...
            "ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ sᴇᴇ [ʟɪsᴛ ᴏғ ᴀᴠᴀɪʟᴀʙʟᴇ ʟᴀɴɢᴜᴀɢᴇ ᴄᴏᴅᴇs](https://t.me/Champu_Links/11).",
            parse_mode="markdown",
...
from ChampuRobot import OWNER_ID, dispatcher
from ChampuRobot import app as client

Champu = "https://telegra.ph/file/6f22d2d88f5b43ab9a805.jpg"
