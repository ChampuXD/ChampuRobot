...
import ChampuRobot.modules.sql.global_bans_sql as gban_sql
import ChampuRobot.modules.sql.users_sql as user_sql
from ChampuRobot import DEV_USERS, OWNER_ID, dispatcher
