...
# from ChampuRobot.modules.sql import warns_sql as warnssql
import ChampuRobot.modules.sql.blacklist_sql as blacklistsql

# from ChampuRobot.modules.sql import cust_filters_sql as filtersql
# import ChampuRobot.modules.sql.welcome_sql as welcsql
import ChampuRobot.modules.sql.locks_sql as locksql
import ChampuRobot.modules.sql.notes_sql as sql

# from ChampuRobot.modules.rules import get_rules
import ChampuRobot.modules.sql.rules_sql as rulessql
from ChampuRobot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from ChampuRobot.__main__ import DATA_IMPORT
from ChampuRobot.modules.connection import connected
from ChampuRobot.modules.helper_funcs.alternate import typing_action
from ChampuRobot.modules.helper_funcs.chat_status import user_admin
from ChampuRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("ChampuRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ChampuRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ChampuRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("ChampuRobot{}.backup".format(chat_id))  # Cleaning file
