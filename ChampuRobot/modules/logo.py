...
from ChampuRobot.modules.nightmode import button_row
from ChampuRobot import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
from ChampuRobot.events import register
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./ChampuRobot/resources/fonts/*")
