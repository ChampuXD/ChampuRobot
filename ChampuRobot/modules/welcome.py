...
import ChampuRobot.modules.sql.wc_sql as sql
from ChampuRobot.modules.sql.toggle_mongo import dwelcome_off, dwelcome_on, is_dwelcome_on
from ChampuRobot.modules.sql.global_bans_sql import is_user_gbanned
from Champu.temp import temp
...
from ChampuRobot import DEV_USERS as SUDO
from ChampuRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)

from ChampuRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from ChampuRobot.modules.helper_funcs.msg_types import get_welcome_type
from ChampuRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from ChampuRobot.modules.log_channel import loggable
from ChampuRobot.utils.can_restrict import can_restrict
...
# <================================================ NORMAL WELCOME FUNCTION =======================================================>import html
# do not async
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                if not ChampuRobot.ALLOW_CHATS:
                ...
                update.effective_message.reply_text(
                    "sᴡᴀɢᴀᴛ ᴛᴏʜ ᴋᴀʀᴏ ʜᴀᴍᴀʀᴀ...😍💖", reply_to_message_id=reply
                )
                continue
