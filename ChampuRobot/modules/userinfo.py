...
from ChampuRobot.modules.alive import Champu
import ChampuRobot.modules.sql.userinfo_sql as sql
...
from ChampuRobot.__main__ import STATS, TOKEN, USER_INFO
from ChampuRobot.modules.disable import DisableAbleCommandHandler
from ChampuRobot.modules.helper_funcs.chat_status import sudo_plus
from ChampuRobot.modules.helper_funcs.extraction import extract_user
from ChampuRobot.modules.sql.global_bans_sql import is_user_gbanned
from ChampuRobot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Champu_Links/10">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url=f"https://t.me/Champu_Links/9"
                            ),
                            InlineKeyboardButton(
                                "Dɪsᴀsᴛᴇʀ", url="https://t.me/Champu_Links/10"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/Champu_Links/9"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/Champu_Links/10"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
