...
@Champu.on_message(filters.command(["short"]))
...
@Champu.on_message(filters.command(["unshort"]))
...
# Champu.add_handler(MessageHandler(short_urls))
# Champu.add_handler(MessageHandler(unshort))
__help__ = """
